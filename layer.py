...
class Convolutional:                                        # convolution layer using 3x3 filters
    ...
    def get_weights_to_save(self):
        return self.filters
    def set_weight(self, weight) :
        self.filters = weight
        print("Set weight for convolutional class :", self.filters.shape, " = ", weight.shape)
...
class FullyConnected:                               # fully-connected layer
    ...
    def set_weight(self, weight) :
        self.weights = weight
        print("Set weight for fc class :", self.weights.shape, " = ", weight.shape)
...
class Dense:                                        # dense layer with softmax activation
    ...
    def set_weight(self, weight) :
        self.weights = weight
        print("Set weight for dense class :", self.weights.shape, " = ", weight.shape)